...
- https://aws.github.io/amazon-ivs-player-docs/1.2.0/web/index.html
...
```
아래 STREAM_URL 변경 
const STREAM_URL = "https://bf6b3e82b49e.us-west-2.playback.live-video.net/api/video/v1/us-west-2.704431722182.channel.vhUxWXf2v8ub.m3u8";
```
